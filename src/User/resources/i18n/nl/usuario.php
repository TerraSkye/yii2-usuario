...
return [
    '(not set)' => '( niet gezet)',
    'A confirmation message has been sent to your new email address' => 'Een bevestigings email is verstuurd naar je nieuwe email adres',
    ...
    'Bio' => '',
    'Block' => 'Geblokeerd',
    'Block status' => 'Geblokeerde status',
    'Blocked at {0, date, MMMM dd, YYYY HH:mm}' => 'Geblokeerd op {0, date, MMMM dd, YYYY HH:mm}',
    'Change your avatar at Gravatar.com' => 'Verander je avatar op Gravatar.com',
    'Children' => '',
    'Class' => '',
    ...
    'Continue' => 'Doorgaan',
    'Create' => 'Nieuw',
    'Create a user account' => 'Nieuwe gebruiker',
    'Create new permission' => 'Nieuwe Permissie',
    'Create new role' => 'Nieuwe rol',
    'Create new rule' => 'Nieuwe regel',
    'Created at' => 'Aangemaakt op',
    'Credentials will be sent to the user by email' => 'Je gegevens worden via email verzonden',
    'Current password' => 'Huidig wachtwoord',
    'Current password is not valid' => 'Huidig wachtwoord is invalide',
    'Delete' => 'Verwijderen',
    'Delete account' => 'Verwijder account',
    'Description' => 'Omschrijving',
    'Didn\'t receive confirmation message?' => '',
    'Disconnect' => 'Loskoppelen',
    'Don\'t have an account? Sign up!' => 'Nog geen account? Registreer nu',
    'Email' => 'Email',
    'Email (public)' => 'publieke Email',
